...
func CreateUser(c *fiber.Ctx) error {
	...
	if validatonErr := validate.Struct(&user); validatonErr != nil {
		return c.Status(http.StatusBadRequest).JSON(responses.UserResponse{
			Status:  http.StatusBadRequest,
			Message: "error",
			Data:    &fiber.Map{"data": validatonErr.Error()},
		})
	}
	newUser := models.User{
...
func DeleteAUser(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(responses.UserResponse{Status: http.StatusOK, Message: "Success", Data: &fiber.Map{"data": "User data successfully deleted"}})
}
...
func GetAllUser(c *fiber.Ctx) error {
	...
	//Reading from database in an optimal way
